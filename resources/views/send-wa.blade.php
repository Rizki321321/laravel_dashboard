...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="{{  asset('css/wa.css')}}">
	<link id="favicon" rel="shortcut icon" type="image/png" href="{{  asset('icon/logo.png')}}">
  </head>
  <body >
  <div class="co">
	<div class="content">
